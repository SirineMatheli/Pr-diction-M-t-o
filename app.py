...
# Initialisation du fichier historique s'il n'existe pas
if not os.path.exists(history_file):
    pd.DataFrame(columns=["prediction", "date", "precipitation", "temp_max", "temp_min", "wind"]).to_csv(history_file, index=False)
